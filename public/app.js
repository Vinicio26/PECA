...
var movil =firebase.initializeApp(firebaseConfig, "second");
...
// var maximo = pulsoMax != null ? parseInt(pulsoMax.value) : 0;
//   var minimo=pulsoMin!=null? parseInt(pulsoMin.value):0;
...
// var longitud = longitudId != null ? parseFloat(longitudId.value):0;//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
// var latitud = latitudId != null ? parseFloat(latitudId.value):0;//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
//     else
//     {
//       alert("Los datos no estan siendo encontrados");
//     }
...
db.collection("users").onSnapshot((querySnapshot) => {
  tabla.innerHTML = '';
  //var id = document.getElementById('idPaciente') != null? document.getElementById('idPaciente').value:0;
  var cont=1;
...
function ubicar(id,NombreCompleto,actual,PulsoMinimo,PulsoMaximo){
...
document.getElementById('pulso-maximoModal').value = PulsoMaximo;x
...
function defEstado(pulsoActual){
  if(pulsoActualPulsoMinimo || pulsoActual>PulsoMaximo){
